...
@dp.message_handler(text=['/advert', 'Реклама'], state=AdminState.categories)
async def get_ad_msg(message: types.Message):
    await AdminState.get_ad_msg.set()
    await message.answer(
        text='Можно отравлять сообщения, фотографии, видео, аудио и голосовые сообщения. По одному',
        reply_markup=admin.markup_deny
    )


@dp.message_handler(content_types=types.ContentTypes.PHOTO, state=AdminState.get_ad_msg)
...
@dp.message_handler(content_types=types.ContentTypes.VIDEO, state=AdminState.get_ad_msg)
...
@dp.message_handler(content_types=types.ContentTypes.AUDIO, state=AdminState.get_ad_msg)
...
@dp.message_handler(content_types=types.ContentTypes.VOICE, state=AdminState.get_ad_msg)
...
@dp.message_handler(content_types=types.ContentTypes.DOCUMENT, state=AdminState.get_ad_msg)
...
@dp.message_handler(state=AdminState.get_ad_msg)
